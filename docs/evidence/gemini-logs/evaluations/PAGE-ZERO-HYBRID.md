# PAGE ZERO
## InfraFabric: Where the Lemmings Learned to Coordinate
...
to treat **manic surges, depressive retreats, and dreaming drift**
...
They are studied, tended, given time.
...
They're **scheduled into the runtime.**
...
the network holds that space open until it wakes.
