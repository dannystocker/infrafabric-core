# Annex B: IF Guardians Charter
## Complete Governance Framework for InfraFabric
...
- Requires 2/3 Guardian approval (4 of 6)
- Prevents unilateral action
- Distributed authority ensures no single Guardian controls outcomes

**Implementation:**
```python
def tier_3_decision(proposal):
    guardian_votes = collect_votes(proposal)
    approvals = [g for g in guardian_votes if g.vote in ['approve', 'conditional']]

    if len(approvals) >= 4:  # 2/3 of 6 Guardians
        return APPROVED
    else:
        return DEFERRED
```
...
- Full proposal text
- Individual Guardian reasoning
- Weights applied
- Final decision + conditions
- Dissenting opinions (preserved, not suppressed)
- Provenance (what evidence cited)

**Transparency:** All Tier 2+ decisions publicly auditable (GDPR-redacted)

### Term Limits & Rotation

**To prevent capture:**
- Guardian roles rotate every 6 months
- No Guardian serves same role >2 consecutive terms
- Rotation ensures fresh perspectives
- Previous Guardians can advise but not vote

**Rotation schedule:**
```
Jan-Jun 2026: Set A Guardians
Jul-Dec 2026: Set B Guardians (50% overlap)
Jan-Jun 2027: Set C Guardians (50% overlap with B)
```
...
**Trigger:** Agent believes decision was unfair or based on incomplete information

**Process:**
1. Agent submits appeal with new evidence
2. Different Guardian set reviews (avoid bias)
3. Decision within 5 business days
4. Appeal effectiveness tracked

**Appeal metrics:**
- Appeal submission rate: Target >1% (shows agents feel empowered)
- Appeal acceptance rate: Target >20% (shows appeals are considered fairly)
- Guardian weight adjustments based on overturned decisions
...
**1. Track Outcome**
- Did safeguards work as intended?
- Were predicted risks realized?
- Did any unpredicted issues emerge?
- What evidence should have been considered?

**2. Update Guardian Weights**
- Guardians who correctly predicted risks → weight ↑
- Guardians who raised false alarms → weight ↓ (but not to 0)
- Late bloomers (minority concerns that proved critical) → amplified

**3. Identify Patterns**
- Which Guardian combinations work best?
- Which domains are often overlooked?
...
```
Decision: Persona agent pilot (Oct 2025)
Ethical Guardian: Predicted labeling confusion (weight 2.0)
Outcome: User confusion DID occur (Guardian was correct)
Learning: Labeling is non-negotiable for all AI-generated content
Action: Update weight for Ethical Guardian on similar decisions → 2.2
Action: Add labeling requirement to standard checklist
```

---

## Guardian Selection & Replacement

### Initial Guardians (Oct 2025)
- Technical: Senior AI architect with reproducibility expertise
- Ethical: Philosophy PhD with AI ethics focus
- Legal: Privacy lawyer with GDPR/AI Act specialization
- Business: Former VC with infrastructure investing background
- User: UX researcher with accessibility focus
- Meta: Technical writer with systems thinking background

### Selection Criteria (for rotation)

**Technical Guardian:**
- 5+ years AI/ML engineering
- Published work on reproducibility
- Experience debugging complex systems

**Ethical Guardian:**
- Ethics training (formal or demonstrated)
- Track record considering edge cases
- Ability to balance principles with pragmatism

**Legal Guardian:**
- Licensed attorney or legal scholar
- GDPR, AI Act, or relevant regulation expertise
- Technology law background

**Business Guardian:**
- 3+ years business strategy or VC
- Infrastructure or SaaS experience
- Ability to separate hype from value

**User Guardian:**
- UX research or advocacy background
- Experience with non-technical users
- Accessibility awareness

**Meta Guardian:**
- Systems thinking demonstrated
- Technical writing or philosophy
- Ability to synthesize across domains

### Nomination & Selection Process

**Every 6 months (rotation cycle):**

1. **Open Nominations (Week 1-2)**
   - Current Guardians nominate replacements
   - Community can nominate candidates
   - Self-nominations allowed

2. **Candidate Review (Week 3-4)**
   - Candidates submit:
     - Resume/CV
     - Written response to hypothetical Guardian scenario
     - Statement of philosophy alignment
   - Meta Guardian reviews for domain fit

3. **Selection (Week 5)**
   - Outgoing Guardians vote on replacements
   - 2/3 approval required
   - Dissents documented

4. **Transition (Week 6)**
   - Incoming Guardian shadows outgoing for 2 weeks
   - Access to all previous debates
   - Mentorship from outgoing Guardian
